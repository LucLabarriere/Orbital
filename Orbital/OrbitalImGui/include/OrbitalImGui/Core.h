...
namespace Orbital
{
	namespace Gui
	{
		static inline void InitializeImGui(Orbital::Window* window)
		{
			IMGUI_CHECKVERSION();
			ImGui::CreateContext();
...
// io.ConfigFlags |= ImGuiConfigFlags_ViewportsEnable;
			...
			if (!Files::AbsoluteExists(io.IniFilename))
				Files::Copy("assets/imgui/default_imgui.ini", "assets/imgui/imgui.ini");
		...
		static inline void TerminateImGui()
		{
