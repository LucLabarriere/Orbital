...
namespace Orbital
{
    ...
    public:
        ...
        static inline EventType GetType() { return EventType::KeyPressed; }
    };
    ...
    public:
        ...
        static inline EventType GetType() { return EventType::KeyReleased; }
    };
    ...
    public:
        ...
        static inline EventType GetType() { return EventType::MouseMove; }
    ...
    public:
        ...
        static inline EventType GetType() { return EventType::MouseButtonPressed; }
    };
    ...
    public:
        ...
        static inline EventType GetType() { return EventType::MouseButtonReleased; }
    };
    ...
    public:
        ...
        static inline EventType GetType() { return EventType::MouseScrolled; }
    ...
    {
    public:
        static inline void Connect(std::function<bool(T& e)> slot) { sSlot = slot; }
        static inline bool OnEvent(T& e) { return sSlot(e); }

    private:
        static inline std::function<bool(T& e)> sSlot;
    };
}
